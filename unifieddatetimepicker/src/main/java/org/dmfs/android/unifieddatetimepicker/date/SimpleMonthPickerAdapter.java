 ...
 */
public class SimpleMonthPickerAdapter extends MonthPickerAdapter
{

    public SimpleMonthPickerAdapter(Context context, PickerContext controller)
    {
    ...
    public MonthView createMonthView(Context context)
    {
        ...
        monthView.setDatePickerController(mPickerContext);
        return monthView;
    }
}
