...
public class HapticFeedbackController
{
    ...
    public void start()
    {
        mHasVibratePermission = PermissionChecker.checkCallingOrSelfPermission(mContext, Manifest.permission.VIBRATE) == PermissionChecker.PERMISSION_GRANTED;
    ...
    {
        if (mHasVibratePermission && mVibrator != null && mIsGloballyEnabled)
        {
